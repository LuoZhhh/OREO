...
examples/train_pcl.py \
     --save_path /workspace/yao/code/OpenRLHF/checkpoint/qwen25-7b-base1020-rl-0120 \
     --save_steps -1 \
     --logging_steps 1 \
     --eval_steps -1 \
     --train_batch_size 32 \
     --micro_train_batch_size 1\
     --pretrain /workspace/yao/code/OpenRLHF/checkpoint/Qwen2.5-Coder-7B-Instruct-SWE-0119-1e-5_bs8_deepseekv3_3916_3\
     --bf16 \
     --max_epochs 1 \
     --max_len 32768 \
     --zero_stage 3 \
     ...
     --task alfworld \
     --only_critic_lora \
     --train_file /workspace/yao/code/swebench_anaylsis/data/rl-dpsk-nebius.jsonl \
     --use_mpi_init
EOF
